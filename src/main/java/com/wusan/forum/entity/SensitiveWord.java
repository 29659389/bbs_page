...
public class SensitiveWord {
    ...
    private String fileName = "D:\\Git\\admin\\src\\main\\resources\\static\\CensorWords.txt";
    ...
    public static void main(String[] args){
        ...
        SensitiveWord sw = new SensitiveWord("D:\\Git\\admin\\src\\main\\resources\\static\\CensorWords.txt");
        ...
        String str = "太多的伤yuming感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
                ...
                + "难过就躺在某一个人的怀里尽情的阐述心扉或者手机卡复制器一个人一杯红酒一部电影在夜三级片 深人静的晚上，关上电话静静的发呆着。rnm,cnm";
    ...
    public String endString(String str){
        SensitiveWord sw = new SensitiveWord("D:/Git/admin/src/main/resources/static/CensorWords.txt");
        sw.InitializationWork();
        str = sw.filterInfo(str);
        return str;
